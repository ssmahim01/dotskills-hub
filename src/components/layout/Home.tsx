...
import { ArrowRight, Check, Zap, ShoppingCart, BarChart3, Users, Cloud } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-40 bg-background/80 backdrop-blur-sm border-b border-border">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg text-foreground">DotSkillsHub</span>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link href={ROUTES.LOGIN} className="text-foreground hover:text-primary transition-colors">
              Sign In
            </Link>
      ...
      <section className="py-20 md:py-32 px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Launch and manage multiple online stores with our comprehensive SaaS platform. Built for
            growth, designed for simplicity.
          </p>
            ...
            {[
              {
                ...
                description: 'Create and manage unlimited e-commerce stores from a single dashboard',
              },
              {
                icon: <Zap className="w-6 h-6" />,
                title: 'Lightning Fast',
                description: 'Optimized performance for maximum conversions and user satisfaction',
              },
              {
              ...
              },
              {
                ...
                title: 'Cloud Hosted',
                description: 'Secure, scalable infrastructure with automatic backups',
              },
              {
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {Object.values(PRICING_TIERS).map((plan) => (
              ...
              >
                ...
                <button className="w-full bg-primary text-primary-foreground py-3 rounded-lg font-semibold mt-8 hover:opacity-90 transition-all">
                  Choose Plan
                </button>
