    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Manage your platform configuration and payment settings
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure accepted payment methods for subscriptions
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg">
            <p className="text-sm text-blue-800 dark:text-blue-200">
              <strong>Note:</strong> Payment method configuration is handled
              through the admin panel. Contact support to enable additional
              payment methods.
            </p>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Instructions displayed to customers when making payments
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4 p-4 bg-muted rounded-lg border">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                1. Open bKash Mobile App
                <br />
                2. Select &quot;Send Money&quot;
                <br />
                3. Enter merchant account: +880 1700 000000
                <br />
                4. Enter amount
                <br />
            ...
            <div className="border-t border-border pt-4">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                2. Select &quot;Send Money&quot;
                <br />
                3. Enter merchant account: +880 1800 000000
                <br />
                4. Enter amount
                <br />
                5. Complete transaction
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            API keys and endpoints for integrations
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="p-4 bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 rounded-lg">
              <p className="text-sm text-yellow-800 dark:text-yellow-200">
                <strong>Warning:</strong> Keep your API key secure. Never share
                it in public or commit it to version control.
              </p>
            </div>
          </div>
        </CardContent>
