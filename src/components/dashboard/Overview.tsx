...
import { Store, TrendingUp, Clock, BarChart3, ArrowUp, ArrowDown } from 'lucide-react';
...
export default function DashboardOverview() {
  ...
  useEffect(() => {
    ...
    const pendingSubscriptions = subscriptionService.getCountByStatus('pending');
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>The latest stores created on your platform</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
              ...
              {recentStores.map((store) => (
                ...
                >
                  <div className="flex-1">
                    <h4 className="font-semibold text-foreground">{store.storeName}</h4>
                    <p className="text-sm text-muted-foreground">{store.subdomain}.dotskills.shop</p>
                  </div>
                  <div className="flex items-center gap-4">
                    <div className="text-right">
                      <p className="text-sm font-medium text-foreground capitalize">{store.package}</p>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-muted-foreground">No stores yet. Create your first store to get started.</p>
            </div>
          )}
        </CardContent>
      </Card>
          ...
          {isLoading ? (
            ...
            <div className="space-y-4">
              <div className="flex gap-4 p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors duration-200">
                ...
                <div className="flex-1">
                  <p className="font-medium text-foreground">New subscription received</p>
                  <p className="text-sm text-muted-foreground">A customer has registered for the Business plan</p>
              ...
              <div className="flex gap-4 p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors duration-200">
                ...
                <div className="flex-1">
                  <p className="font-medium text-foreground">Store created successfully</p>
                  <p className="text-sm text-muted-foreground">&quot;Fashion Fusion&quot; store has been activated</p>
              ...
              <div className="flex gap-4 p-4 border border-border rounded-lg hover:bg-accent/50 transition-colors duration-200">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-muted-foreground">Transaction from Ahmed Hassan has been confirmed</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              <span className="text-green-600 dark:text-green-400">+18.5%</span> compared to last year
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-sm text-muted-foreground mt-2">
              <span className="text-green-600 dark:text-green-400">+24.3%</span> new customers this month
            </p>
          </CardContent>
        </Card>
      </div>
